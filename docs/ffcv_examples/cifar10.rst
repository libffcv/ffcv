...
We also provide the code `here <https://github.com/MadryLab/ffcv/blob/main/examples/cifar/train_cifar.py>`_ and the corresponding script `here <https://github.com/MadryLab/ffcv/blob/main/examples/cifar/train_cifar.sh>`_.
